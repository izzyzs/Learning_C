/*
    ...
    exercise 1-20 to 1-24 from 1.10 (page 46:pdf 34:book)
    (External Variables and Scope pdf:43 book:31)
    ...
    Exercise 1-21. Write a program e n t a b that replaces strings 
    of blanks by the minimum number of tabs and blanks to achieve 
    the same spacing. Use the same tab stops as for d e t a b . 
    ...
    does something intelligent with very long lines, and fi there are no
    ...
    constants properly. C com- ments do not nest.
